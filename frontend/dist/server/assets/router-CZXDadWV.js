...
const appCss = "/assets/styles-CBP7ZNov.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "MIPS Pipeline Simulator" },
      { name: "author", content: "Pipeline Simulator" },
      { property: "og:title", content: "Pipeline Simulator" },
      { property: "og:description", content: "MIPS Pipeline Simulator" },
...
const $$splitComponentImporter = () => import("./index-FAYxY_Bz.js");
